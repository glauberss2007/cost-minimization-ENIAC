...
namespace predictions {
    class user_preferences {
      public:
        ...
        int getCaloriesBurn() const;
        std::vector<std::string> getHobbies() const;
        std::string getHobbie(int i) const;
        double getImc() const;
        std::vector<int> getMealsTime() const;
        int getMealstimeHour(int i) const;
        int getNumberOfMealsTime() const;
        double getTarget() const;
        int getGender() const;
        std::vector<int> getBreakfastPreferences() const;
        std::vector<int> getBreakfastPreferencesPortions() const;
        std::vector<int> getSnack1Preferences() const;
        std::vector<int> getSnack1PortionPreferences() const;
        std::vector<int> getLunchPreferences() const;
        std::vector<int> getLunchPortionsPreferences() const;
        std::vector<int> getSnack2Preferences() const;
        std::vector<int> getSnack2PreferencesPortions() const;
        std::vector<int> getDinnerPreferences() const;
        std::vector<int> getDinnerPreferencesPortions() const;
        std::vector<int> getPreferenciasCeia() const;
        std::vector<int> getPorcaoPreferenciasCeia() const;
